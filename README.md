...
This MVP is still local-first. The SQLite database on Vercel is suitable only for a demo because serverless storage is not durable. For a real public app, switch Prisma to a hosted Postgres database before collecting user API keys.
